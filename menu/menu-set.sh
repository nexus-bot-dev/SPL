...
14 | 14) clear ; about ;;
15 | 15) clear ; jam ;;
16 | 16) clear ; wget https://raw.githubusercontent.com/nexus-bot-dev/SPL/main/udpcustom/udp-custom.sh && chmod +x udp-custom.sh && ./udp-custom.sh ;;
17 | 17) clear ;
echo -e "PROSES INSTALASI UDPGW MINI 7100, 7200, 7300"; sleep 5;

mkdir -p /usr/local/kyt/
wget -q -O /usr/local/kyt/udp-mini "https://raw.githubusercontent.com/nexus-bot-dev/SPL/main/udpcustom/udp-mini"
chmod +x /usr/local/kyt/udp-mini
wget -q -O /etc/systemd/system/udp-mini-1.service "https://raw.githubusercontent.com/nexus-bot-dev/SPL/main/udpcustom/udp-mini-1.service"
wget -q -O /etc/systemd/system/udp-mini-2.service "https://raw.githubusercontent.com/nexus-bot-dev/SPL/main/udpcustom/udp-mini-2.service"
wget -q -O /etc/systemd/system/udp-mini-3.service "https://raw.githubusercontent.com/nexus-bot-dev/SPL/main/udpcustom/udp-mini-3.service"
