...
wget -q -O /etc/pam.d/common-password "https://raw.githubusercontent.com/nexus-bot-dev/SPL/main/tools/password"
...
wget -q -O /usr/local/bin/ws-dropbear "https://raw.githubusercontent.com/nexus-bot-dev/SPL/main/tools/ws-dropbear"
...
wget -q -O /usr/local/bin/ws-stunnel "https://raw.githubusercontent.com/nexus-bot-dev/SPL/main/tools/ws-stunnel"
chmod +x /usr/local/bin/ws-stunnel

# Installing Service Ovpn Websocket
cat > /etc/systemd/system/ws-stunnel.service << END
[Unit]
Description=Ovpn Websocket By NEXUSS
Documentation=https://web.cobeksawit.xyz:5255
After=network.target nss-lookup.target
[Service]
Type=simple
...
wget -q -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/nexus-bot-dev/SPL/main/tools/newudpgw"
...
# Install Stunnel5
cd /root/
wget -q "https://raw.githubusercontent.com/nexus-bot-dev/SPL/main/tools/stunnel5.zip"
unzip stunnel5.zip
cd /root/stunnel
chmod +x configure
./configure
...
wget -q -O /etc/init.d/stunnel5 "https://raw.githubusercontent.com/nexus-bot-dev/SPL/main/tools/stunnel5.init"
...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/nexus-bot-dev/SPL/main/issue.net"
