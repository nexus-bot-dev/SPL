...
Isadmin=$(curl -sS https://raw.githubusercontent.com/AngIMAN/izin/main/ip | grep $MYIP | awk '{print $5}')
...
Exp=$(curl -sS https://raw.githubusercontent.com/AngIMAN/izin/main/ip | grep $MYIP | awk '{print $3}')
fi
